...
@keyframes blink-caret {
  ...
  50% { border-color: rgb(22, 18, 241); }
    ...
    <body>
        ...
        <form method="post" action="try3.php" enctype="multipart/form-data">
            ...
            <label for="theme1">Pizza Shop</label><br>
            <input type="radio" id="theme2" name="theme" value="Theme2">
            <label for="theme2">Grocerry Shop</label><br>
